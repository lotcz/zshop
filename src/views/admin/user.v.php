<div class="inner cover">	
	<form method="post" action="/admin/user" class="form-horizontal admin-form">
		...
		<div class="form-group">
			...
			<div class="col-sm-6"><input type="text" maxlength="100" name="user_login" value="<?=$data->val('user_login') ?>" class="form-control" /></div>
		</div>		
		<div class="form-group">
			<label for="user_email" class="col-sm-2 control-label"><?= t('E-mail') ?>:</label>
			<div class="col-sm-6"><input type="text" name="user_email" maxlength="255" value="<?=$data->val('user_email') ?>" class="form-control" /></div>
			<div class="col-sm-4 form-validation" id="user_email_validation"><?= t('Required.') ?></div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="user_last_access" class="col-sm-2 control-label"><?= t('Last visit') ?>:</label>
