<div class="inner cover">	
	<form method="post" action="/admin/customer" class="form-horizontal">
		<input type="hidden" name="customer_id" value="<?=$data->val('customer_id') ?>" />
		<div class="form-group">
			<label for="customer_login" class="col-sm-5 control-label"><?= t('Login:') ?></label>
			<div class="col-sm-7">
				<input type="text" name="customer_login" value="<?=$data->val('customer_login') ?>" class="form-control" />
			</div>
		</div>
		<div class="form-group">
			<label for="customer_email" class="col-sm-5 control-label"><?= t('E-mail:') ?></label>
			<div class="col-sm-7">
				<input type="text" name="customer_email" value="<?=$data->val('customer_email') ?>" class="form-control" />
			</div>
